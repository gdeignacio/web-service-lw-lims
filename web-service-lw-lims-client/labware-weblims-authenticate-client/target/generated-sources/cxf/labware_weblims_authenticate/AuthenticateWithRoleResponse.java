...
@XmlRootElement(name = "authenticateWithRoleResponse")
public class AuthenticateWithRoleResponse {

    @XmlElementRef(name = "return", namespace = "labware_weblims_authenticate", type = JAXBElement.class)
