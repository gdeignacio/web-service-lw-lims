 ...
 */
package es.caib.sgtsic.labware.weblims.authenticate.client;

import es.caib.sgtsic.labware.weblims.authenticate.utils.UtilsIO;
...
public class DatosConexionLabwareWebLimsAuthenticate {
    ...
    public static final String codclient = "labware.weblims.authenticate.client";
